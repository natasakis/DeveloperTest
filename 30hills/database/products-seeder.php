...
try {
    ...
    foreach ($products as $product) {
        $sqlQueryString = "INSERT INTO products (id, name, description, features, price, keywords, url, category, subcategory, images)"
                        . " VALUES (" . ":id" . ", " . ":name" . ", " . ":description" . "," . ":features" . ", " . ":price" . ", " . ":keywords" . ", " . ":url" . ", " . ":category" . "," . ":subcategory" . "," . ":images" . ")";
