        ...
        <div class="row">
            <div class="col-6 mb-5">
                <form class="p-4" action="./checkout-page.php" method="post" style="border: solid black 2px; border-radius: 2%;">
                    ...
                    <button type="submit" class="btn btn-dark mt-5 mb-5" name="buy" value="yes">Buy</button>
            ...
            <div class="col-6">
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach ($items as $item) { ?>
                            ...
                            <div class="item-container row">
                                <div class="col-4">
                                    <img width="100px" height="100px" src="<?php $pos=strpos(($item->getProduct()->img),','); echo substr(($item->getProduct()->img),1,$pos-2); ?> " alt="Card image cap">
                                </div>
                                <div class="col-8">
                                    <h3 class="card-title"><?php echo htmlspecialchars($item->getProduct()->title); ?></h3>
                                    <p class="text-danger"><span class="text-dark">Price:</span> <?php echo htmlspecialchars($item->getProduct()->price); ?> $</p>
                                    <p class="text-danger"><span class="text-dark">Quantity:</span> <?php echo htmlspecialchars($item->getQuantity()); ?></p>
                                    <p class="text-danger"><span class="text-dark">Price with quantity: </span><?php echo htmlspecialchars($subtotal); ?> $</p>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                ...
                <div class="d-flex justify-content-between">
                    <h3 class="text-dark">TOTAL:</h2>
                    <h3 class="text-danger"><?php echo htmlspecialchars($total); ?> $</h2>
                </div>
            </div>
        </div>
    </div>
